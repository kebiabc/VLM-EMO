...
parser.add_argument('--load_and_tune_prompt_learner', default='False') 
...
def main(set):
    ...
    # define optimizer
    optimizer = torch.optim.Adam([{"params": model.module.temporal_net.parameters(), "lr": args.lr},
    ...
    # Data loading code
    # train_loader = CAERSDataLoader(root= "caer/CAER-master/CAER/data/CAER-S/train",     
    #     detect_file= "caer/CAER-master/CAER/data/train.txt", 
    #     batch_size= 32,              
    #     shuffle= 'true',               
    #     num_workers= 16)


    # val_loader = CAERSDataLoader(root= "caer/CAER-master/CAER/data/CAER-S/test",     
    #     detect_file= "caer/CAER-master/CAER/data/test.txt", 
    #     train='false',
    #     batch_size= 32,              
    #     shuffle= 'true',               
    #     num_workers= 16)
    ...
    train_data = MyDataset(root= "CAER-S/train",input_file= "CAER-S/train.txt",transform=data_transforms)
    test_data = MyDataset(root= "CAER-S/test",input_file= "CAER-S/test.txt",transform=data_transforms)
